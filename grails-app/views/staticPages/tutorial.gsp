  ...
  <body>
    <div id = "tutorial">
      ...
      <p class ="text-content">
        ...
        Now in this folder you may create staticPages by creating files with the extenstion <code>.gsp</code>
      </p>
      <p class = "text-content">
        ...
        <p class = "text-content">
          The code above adds a mapping to our <code>helloworld.gsp</code> file.
        </p>
